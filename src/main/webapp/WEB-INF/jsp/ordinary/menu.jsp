...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        <li><a href="${pageContext.request.contextPath}/ordinary/showMask">口罩信息<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/ordinary/reserveMask">预约口罩<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>

        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <h1 style="text-align: center;">添加口罩预约</h1>
                    </div>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form"
                          action="${pageContext.request.contextPath}/ordinary/reserveMask" id="editfrom" method="post">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">预约人</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label" name="date">预约日期</label>
                            <div  class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label" name="beginTime">领取时间</label>
                            <div class="col-sm-10">
